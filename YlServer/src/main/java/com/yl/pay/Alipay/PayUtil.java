...
import com.yl.pay.Alipay.util.CollectionUtil;
...
//		return SignUtils.sign(authInfo.toString(), rsaKey);
       try {
    	   sign =  AlipaySignature.rsaSign(authInfo.toString(), rsaKey, AlipayConstants.CHARSET_UTF8, AlipayConstants.SIGN_TYPE_RSA);
