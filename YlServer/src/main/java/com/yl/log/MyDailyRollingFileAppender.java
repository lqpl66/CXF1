...
public class MyDailyRollingFileAppender extends FileAppender {
	private static Logger log = Logger.getLogger(MyDailyRollingFileAppender.class);
    ...
    void printPeriodicity(int type) {
        switch(type) {
            case TOP_OF_MINUTE:
                ...
                break;
            case TOP_OF_HOUR:
            	log.debug("Appender ["+name+"] to be rolled on top of every hour.");
                break;
            case HALF_DAY:
            	log.debug("Appender ["+name+"] to be rolled at midday and midnight.");
                break;
            case TOP_OF_DAY:
            	log.debug("Appender ["+name+"] to be rolled at midnight.");
                break;
            case TOP_OF_WEEK:
            	log.debug("Appender ["+name+"] to be rolled at start of week.");
                break;
            case TOP_OF_MONTH:
            	log.debug("Appender ["+name+"] to be rolled at start of every month.");
                break;
            default:
